...
export const socialPostSchema = z.object({ id: z.uuid(), ownerPublicId: z.string().optional(), author: authorSchema, content: z.string(), sharedPostId: z.uuid().optional(), sharedPost: sharedPostSchema.optional(), media: z.array(socialMediaSchema).max(2).optional(), visibility: socialVisibilitySchema, createdAtMs: z.number(), updatedAtMs: z.number(), editedAtMs: z.number().optional(), likeCount: z.number().int(), commentCount: z.number().int(), likedByViewer: z.boolean(), campedByViewer: z.boolean(), ownedByViewer: z.boolean() });
